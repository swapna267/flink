...
public class StreamPhysicalMLPredictTableFunctionRule extends ConverterRule {
    ...
    public static boolean isPython(RexModelCall modelCall) {
        String language = modelCall.getContextResolvedModel().getResolvedModel().getLanguage();
